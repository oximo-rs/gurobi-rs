...
You can use the ScenarioNumber parameter, in conjunction with multi-scenario attributes ( `ScenNLB` , `ScenNUB` ,
`ScenNObj` , `ScenNRHS` , `ScenNName` , etc.), to query or modify attributes for different scenarios. The value of
ScenarioNumber should always be less than `NumScenarios` .
