...
Assume there are \(l\) linear, \(q\) quadratic, \(s\) SOS and \(g\) general constraints and the index \(i\) is between
\(l+q+s\) and \(l+q+s+g\) . Then, the general constraint with index \(i-l-q-s\) has the biggest violation.
