...
For the NL barrier algorithm, the primal feasibility error must be smaller than `NLBarPFeasTol` in order for a model to
be declared locally optimal. Due to problem transformations like presolve or internal scaling, the returned solution’s
