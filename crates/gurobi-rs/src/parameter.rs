...
/// use gurobi_rs::parameter::Parameter;
///
...
/// let result : gurobi_rs::Result<String> = m.get_param(&undocumented_parameter);
/// assert!(matches!(result, Err(gurobi_rs::Error::FromAPI(_, _))));
///
